...
{lectureNotes.map((notes)=>(
  ...
  <div className="col col-4" data-label="Lecture File"><a href={`http://localhost:9000/api/course/${notes.file_path}`} target='_blank' download={notes.course_title}>{notes.course_title}</a></div>
